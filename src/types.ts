...
export interface DirectLink {
  ...
  url: string;
  isPrimary?: boolean;
  type?: 'apply' | 'notification' | 'result' | 'results' | 'admit' | 'admit-card' | 'admit_card' | 'answer' | 'answer-key' | 'answer_key' | 'website' | 'official_website' | 'official-website' | 'official' | 'status' | 'syllabus' | 'login' | 'registration' | 'download' | 'other' | (string & {});
}
