...
import { ShieldCheck, Mail, Globe, Heart, ExternalLink } from 'lucide-react';
...
export const Footer: React.FC<FooterProps> = ({ onSelectCategory, onOpenAdmin, onOpenPWAAlerts, onOpenFeedback, onOpenLegalPage, isAdminMode, language = 'en' }) => {
  return (
