      ...
      {displayedArticles.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {displayedArticles.map((rawArt, index) => {
            ...
            return (
              <div key={`${art.id || 'ca'}-${index}`} className="border border-slate-200 rounded-xl p-4 bg-slate-50/70 hover:bg-slate-50 hover:border-amber-300 transition-all space-y-4 relative overflow-hidden group shadow-sm flex flex-col justify-between">
